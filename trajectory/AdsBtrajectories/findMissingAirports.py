...
if __name__ == '__main__':
    ...
    if airportsDBOk:
        ...
        if count > 0:
            print("there are airports in challenge and final submission - not in Airports database")
        else:
            print("all airports Adep and Ades of the challenge set and the final submission set are in the Airports database")
