...
if __name__ == '__main__':
    ...
    if ( faaAircraftDatabase.read()):
        ...
        print("unique aircrafts  = {0}".format(unique_aircrafts_challenge))
        ...
        print("unique airccrafts  = {0}".format(unique_aircrafts_submission))
        ...
        print( len ( unique_aircrafts.index ))
